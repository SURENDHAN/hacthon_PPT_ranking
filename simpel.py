...
def load_llm_model():
    try:
        return ChatGoogleGenerativeAI(
            ...
            temperature=0.1,
            google_api_key='AIzaSyCtVJ0Ka3Y1n41QI6GfXLSzGaEYb2fEi' 
        )
...
IMPORTANT: Focus ONLY on the CORE TECHNICAL CONTENT of the presentation. Ignore introductory slides, team member details, basic titles of the every page of the ppt, and other non-substantive information.
...
# 📌 PRESENTATION CONTENT:
    ...
    # EVALUATION TASK:
    1. FIRST, extract only the technical and substantive content from the presentation
    2. THEN, provide a detailed evaluation based on specific criteria
    3. FORMAT your response exactly as requested below

**MANDATORY REQUIREMENTS**:
- **DO NOT OMIT** any category.
- **ALWAYS** include the "Overall Score" section.
- **FOLLOW the exact JSON & human-readable format below.**

    # EVALUATION CRITERIA:
    Evaluate on these four dimensions using a scale of 1-10:
    
    "Innovation": "Originality, creativity, and uniqueness of the idea, considering the knowledge and skills of college students. Novel approach to problem-solving using emerging technologies or unconventional methodologies. The extent to which the idea challenges traditional solutions and introduces fresh perspectives.",
    "Technical Feasibility": "Practicality and ease of implementation using accessible tools, resources, and technology. Clarity in defining the problem statement and the technical soundness of the proposed solution. Consideration of constraints such as time, budget, hardware/software availability, and skill level.",
    "Impact": "Potential to address real-world problems and contribute meaningful solutions. Social, economic, and environmental benefits of the idea. Practicality of deploying the solution in academic, industrial, or community settings.",
    "Technical Depth": "Sophistication and complexity of the approach while maintaining alignment with the problem statement. Justification for choosing specific technologies, algorithms, frameworks, or methodologies. Depth of research, technical understanding, and integration of best practices.",
    "Presentation Quality": "Clarity, organization, and logical flow of the presentation. Effectiveness of slides in conveying technical and non-technical aspects of the solution. Engaging storytelling, well-structured visuals, and concise yet impactful explanations.",
    "Scalability": "Potential to expand the solution beyond its initial scope to broader applications. Adaptability to different industries, geographies, or user bases. Consideration of performance, efficiency, and resource optimization for large-scale deployment.",
    "Market Potential": "Existence of a real-world demand or audience for the idea. Commercial feasibility, sustainability, and competitive positioning of the solution. Viability of adoption by businesses, government agencies, or communities."


    # RESPONSE FORMAT:
    Return your evaluation as JSON within triple backticks, AND also in a human-readable format afterward.
    ...
    After the JSON, include a formal evaluation in this exact format:

    ## Innovation: (Score X.X/10)
    Justification: [Your detailed justification including strengths and areas for improvement]

    ## Technical Feasibility: (Score X.X/10)
    Justification: [Your detailed justification including strengths and areas for improvement]

    ## Impact: (Score X.X/10)
    Justification: [Your detailed justification including strengths and areas for improvement]

    ## Technical Depth: (Score X.X/10)
    Justification: [Your detailed justification including strengths and areas for improvement]
    
    ## Presentation Quality: (Score X.X/10)
    Justification: [Your detailed justification including strengths and areas for improvement]
    
    ##Scalability: (Score X.X/10)
    Justification: [Your detailed justification including strengths and areas for improvement]
    
    ##Market Potential: (Score X.X/10)
    Justification: [Your detailed justification including strengths and areas for improvement]
